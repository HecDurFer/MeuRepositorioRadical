...
def verificar_escolha():
    ...
    if jogada_jogador1 in ['pedra', 'papel', 'tesoura']:
        ...
        label_resultado.config(text="Escolha inválida! Por favor, escolha pedra, papel ou tesoura.")

#correção: adicionar uma ação para caso o input do jogador seja inválido, como na linha acima
